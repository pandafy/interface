...
function creatFile() {
    window.resolveLocalFileSystemURL(cordova.file.externalCacheDirectory, function (dirEntry) {
        ...
        var isAppend = false;
        createFile(dirEntry, "data.json", isAppend);
    }, onErrorLoadFs);
}
    ...
    function readFile(fileEntry) {
        ...
        fileEntry.file(function (file) {
           ...
           //file = file.substr(1);
           //var jData = jQuery.parseJSON(file);
           a//lert('jdata : s'+jData);
        },onErrorLoadFs );
    }
...
<<<<<<< HEAD
    function cb(){
        alert('you have reached callback for file read');
    }

    //window.resolveLocalFileSystemURL(cordova.file.externalCacheDirectory, successCallback, errorCallback);

    var type = cordova.file.externalCacheDirectory;
    var size = 5*1024*1024;
   // window.requestFileSystem(cordova.file.externalApplicationStorageDirectory, size, successCallback, errorCallback);
